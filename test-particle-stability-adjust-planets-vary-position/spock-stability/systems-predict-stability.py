...
f_1_rand = ic['f_1_rand'] # inner planet initial positions (radians)
f_2_rand = ic['f_2_rand'] # outer planet initial positions (radians)
...
for nsim in nsim_list:
    ...
    sim.add(m=m_1, P=P_1, e=e_1_rand[nsim], inc=inc_1_rand[nsim], pomega=pomega_1_rand[nsim], f=f_1_rand[nsim])
    sim.add(m=m_2, P=P_2, e=e_2_rand[nsim], inc=inc_2_rand[nsim], pomega=pomega_2_rand[nsim], f=f_2_rand[nsim])
