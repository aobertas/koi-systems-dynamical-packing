...
# f_1_min: lower bound for inner planet initial position (radians)
# f_1_max: upper bound for inner planet initial position (radians)
# f_1_rand: inner planet initial positions (radians)
# f_2_min: lower bound for outer planet initial position (radians)
# f_2_max: upper bound for outer planet initial position (radians)
# f_2_rand: outer planet initial positions (radians)
...
outdir = "/mnt/scratch-lustre/obertas/koi-systems-dynamical-packing/test-particle-stability-adjust-planets-vary-position/" # root directory where simulation data files will be saved
job_pre = "sim"
...
f_1_min = 0 # lower bound for inner planet initial position (radians)
f_1_max = 2 * np.pi # upper bound for inner planet initial position (radians)
f_1_rand = np.random.uniform(f_1_min,f_1_max,Nsims) # inner planet initial positions (radians)

f_2_min = 0 # lower bound for outer planet initial position (radians)
f_2_max = 2 * np.pi # upper bound for outer planet initial position (radians)
f_2_rand = np.random.uniform(f_2_min,f_2_max,Nsims) # outer planet initial positions (radians)
...
np.savez(outfile,outdir=outdir,job_pre=job_pre,archive_flag=archive_flag,archive_interval=archive_interval, \
                 ...
                 f_1_min=f_1_min,f_1_max=f_1_max,f_2_min=f_2_min,f_2_max=f_2_max, \
                 f_1_rand=f_1_rand,f_2_rand=f_2_rand,f_test=f_test, \
