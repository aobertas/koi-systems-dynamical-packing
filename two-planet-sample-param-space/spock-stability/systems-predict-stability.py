...
test-particle-stability-arbitrary-planets/generate-and-run-systems/initial-conditions-" + ic_file + ".npz"
...
for nsim in nsim_list:
    ...
    for i in range(N_planets):
        sim.add(m=m_planets[i], P=P_planets[i], e=e_rand[i, nsim], inc=inc_rand[i, nsim], \
                pomega=pomega_rand[i, nsim], f=f_rand[i, nsim])
