...
outdir = "/mnt/scratch-lustre/obertas/koi-systems-dynamical-packing/test-particle-stability-delta-15/" # root directory where simulation data files will be saved
job_pre = "sim"
