...
test-particle-stability-delta-15/spock-stability/np-binary-probability-files/"\
...
test-particle-stability-delta-15/generate-and-run-systems/initial-conditions-" + ic_file + ".npz"
