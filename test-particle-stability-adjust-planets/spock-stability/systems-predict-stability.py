...
pomega_1_rand = ic['pomega_1_rand'] # inner planet orbit orientations (radians)
pomega_2_rand = ic['pomega_2_rand'] # outer planet orbit orientations (radians)
# note: pomega_test is set for the sake of consistency, but it is UNDEFINED for a circular orbit
pomega_test = ic['pomega_test'] # test particle orbit orientation (radians)
