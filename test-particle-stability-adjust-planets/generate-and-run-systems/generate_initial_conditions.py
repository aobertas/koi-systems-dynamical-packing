...
pomega_1_min = 0 # lower bound for inner planet orbit orientation (radians)
pomega_1_max = 2 * np.pi # upper bound for inner planet orbit orientation (radians)
pomega_1_rand = np.random.uniform(pomega_1_min,pomega_1_max,Nsims) # inner planet orbit orientations (radians)

pomega_2_min = 0 # lower bound for outer planet orbit orientation (radians)
pomega_2_max = 2 * np.pi # upper bound for outer planet orbit orientation (radians)
pomega_2_rand = np.random.uniform(pomega_2_min,pomega_2_max,Nsims) # outer planet orbit orientations (radians)
...
pomega_test = 0 # test particle orbit orientation (radians)
